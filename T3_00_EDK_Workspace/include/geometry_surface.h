...
namespace EDK3 {
    ...
    public:
        ...
        void init(const float* surface_points, const int num_heights = 4, const int num_revs = 4);
        virtual bool bindAttribute(const Attribute a, unsigned int where_to_bind_attribute) const override;
